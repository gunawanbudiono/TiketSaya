...
public class MyTickectDetailAct extends AppCompatActivity {

    TextView xnama_wisata, xlokasi,
            xdate_wisata, xtime_wisata,
            xketentuan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_tickect_detail);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gotoprofile = new Intent(MyTickectDetailAct.this,MyProfileAct.class);
